...
function SkillJumpAttack:Begin(avatar, callBack)
    ...
    self.avatar.aniEvent:SetListenerByMsg(WarAvatar.ANI_EVENT_SKILL_HIT, function()
        ...
        local eff = CreatePrefab("Effect/Prefabs/fx_dust_wave.prefab", self.avatar.target.transform.parent, 1)
        eff.transform.localPosition = self.avatar.target.transform.localPosition + Vector3.New(0, 0.5,0)
