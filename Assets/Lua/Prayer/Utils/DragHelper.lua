...
function DragHelper:Ctor(gameObject, moveRT, dragCall, endDragCall, startDragCall)
    ...
    self.startDragLuaFun = handler(self, self.BeginDragHandler)
    self.dragLuaFun = handler(self, self.DragHandler)
    self.endDragLuaFun = handler(self, self.EndDragHandler)
