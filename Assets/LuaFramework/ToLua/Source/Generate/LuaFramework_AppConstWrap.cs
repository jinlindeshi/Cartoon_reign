...
public class LuaFramework_AppConstWrap
{
	...
	static int get_ResPathHead(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushstring(L, LuaFramework.AppConst.ResPathHead);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_GameServerIP(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushstring(L, LuaFramework.AppConst.GameServerIP);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_GameServerPort(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushinteger(L, LuaFramework.AppConst.GameServerPort);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int set_GameServerIP(IntPtr L)
	{
		try
		{
			...
			LuaFramework.AppConst.GameServerIP = arg0;
			return 0;
		}
		catch (Exception e)
		{
	...
	static int set_GameServerPort(IntPtr L)
	{
		try
		{
			...
			LuaFramework.AppConst.GameServerPort = arg0;
			return 0;
		}
		catch (Exception e)
		{
