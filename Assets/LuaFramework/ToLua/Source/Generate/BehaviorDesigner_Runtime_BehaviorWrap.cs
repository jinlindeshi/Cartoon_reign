...
public class BehaviorDesigner_Runtime_BehaviorWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("GetAllVariables", GetAllVariables);
		...
		L.RegFunction("StartTaskCoroutine", StartTaskCoroutine);
		L.RegFunction("StopTaskCoroutine", StopTaskCoroutine);
		L.RegFunction("StopAllTaskCoroutines", StopAllTaskCoroutines);
		L.RegFunction("TaskCoroutineEnded", TaskCoroutineEnded);
	...
	static int set_gizmoViewMode(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			BehaviorDesigner.Runtime.Behavior obj = (BehaviorDesigner.Runtime.Behavior)o;
			BehaviorDesigner.Runtime.Behavior.GizmoViewMode arg0 = (BehaviorDesigner.Runtime.Behavior.GizmoViewMode)ToLua.CheckObject(L, 2, typeof(BehaviorDesigner.Runtime.Behavior.GizmoViewMode));
