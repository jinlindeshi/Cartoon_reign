...
namespace BitBenderGames
{
	...
	public class FocusCameraOnItem : MonoBehaviourWrapped
	{
		...
		public static FocusCameraOnItem Instance;

		[SerializeField]
		private float transitionDuration = 1.5f;
		private float transitionDuration_Drag = 3.2f;
		...
		public delegate void TargetFocused_Complete ();


		public TargetFocused_Complete FocusCompleted_Delegate;
		...
		public void KeepInFocusDuringDrag (Vector3 targetPosition)
		{
			KeepinCenter (targetPosition, Transform.rotation, MobileTouchCamera.CamZoom);
		}
...
//			Debug.Log ("target zoom "+ targetZoom);
		...
		private void SetTransform (Vector3 newPosition, Quaternion newRotation, float newZoom)
		{
			...
			if (FocusCompleted_Delegate != null) {
				FocusCompleted_Delegate ();
			}
		}
	}
}
