...
namespace BitBenderGames
{
    ...
    private AutoScrollDampMode autoScrollDampMode = AutoScrollDampMode.DEFAULT;
		...
		private bool truckTutorial = false;
		...
		private bool enableOvertiltSpring = false;
		//Allows to enable the camera to spring being when being tilted over the limits.
		private float camOvertiltMargin = 5.0f;
		private float tiltBackSpringFactor = 30;
		private float minOvertiltSpringPositionThreshold = 0.1f;
		...
		public void InputControllerOnFingerDown (Vector3 pos)
		{
			cameraScrollVelocity = Vector3.zero;
		}

		public void InputControllerOnFingerUp ()
		{
			isDraggingSceneObject = (false || showingPopUp || showingShop || truckTutorial);
		}

		public void setDragMode (bool isShowing)
		{
			showingPopUp = isShowing;
			isDraggingSceneObject = showingPopUp;
		}

		public void setShopMode (bool isShowing)
		{
			showingShop = isShowing;
			isDraggingSceneObject = showingShop;
		}

		public void setTruckTutorialMode (bool isShowing)
		{
			truckTutorial = isShowing;
			isDraggingSceneObject = truckTutorial;
		}
